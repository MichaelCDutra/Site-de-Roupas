...
🔗 **Demo – Vitrine Pública**
(Frontend estático – GitHub Pages)
[https://michaelcdutra.github.io/vitrineTeste/](https://michaelcdutra.github.io/vitrineTeste/)

> ⚠️ **Observação**: esta vitrine foi criada **exclusivamente para fins de demonstração**, com o objetivo de testar e apresentar as funcionalidades do SaaS.
> A vitrine final de cada lojista pode ser desenvolvida de **diversas formas no frontend**, mantendo a mesma API e regras de negócio.

👉 **Demo – Painel Administrativo (SaaS)**
(Frontend – GitHub Pages | Backend em ambiente privado)
[https://michaelcdutra.github.io/Site-de-Roupas/](https://michaelcdutra.github.io/Site-de-Roupas/)

> 🔐 **Credenciais de demonstração**
> Ambiente de teste com dados fictícios. Nenhuma informação real de clientes é utilizada.
>
> **Super Admin**
